...
=======
# server-temperature-mongo

It's my first server with **mongodb** and **nodejs** for storage a **temperature values** from my **arduino** with **Ethernet shield**

every 30min, arduino send a post request to server and this save the temperature value on mongodb database.
